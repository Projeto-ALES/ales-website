...
const Volunteer = () => {
    return (
        <div className={styles.container}>
            ...
            <p>Você pode escolher uma das áreas ou, se quiser, pode se inscrever nas duas, sem nenhum problema!</p>

            <p>Venha fazer parte do nosso time! Clique no link abaixo e preencha o formulário. Assim que o nosso processo seletivo abrir, entraremos em contato com você!</p>
