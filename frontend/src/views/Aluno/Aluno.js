...
const Volunteer = () => {
    return (
        <div className={styles.container}>
            <p>
                Quer ser aluno ou aluna do projeto ALES? As aulas desse semestre já começaram, mas se você quiser participar do próximo semestre, basta preencher o nosso formulário de interesse (disponível no final desta página). Dessa forma, quando abrirmos as vagas para o próximo semestre, entraremos em contato com você e enviaremos todas as informações necessárias, assim como o formulário de inscrição.
            </p>
            ...
            <p><strong>Quais são as aulas?</strong></p>
